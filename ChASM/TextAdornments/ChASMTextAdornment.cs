...
#pragma warning restore 169
            ...
            ref ITextViewLine line, ref int charIndex)
        {
            ...
            var textBlock = Utils.CreateTextBlock(TextBlockType.OneLineComment, currentComment);
            ...
            ref int charIndex)
        {
            ...
            if (Globalz.GPRs.Any(a => a.StartsWith(register)) == false &&
                Globalz.Specials.Any(a => a.StartsWith(special)) == false)
            {
